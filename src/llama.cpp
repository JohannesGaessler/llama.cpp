...
void llama_params_optimize(const char * path_model, struct llama_model_params * mparams, struct llama_context_params * cparams) {
    ...
    for (size_t i = 0; i < model->n_devices(); ++i) {
        size_t nbytes = model->nbytes_allocated(i);
    }
}
