...
typedef void (*load_tiles_cuda_t)(
    ...
    int * __restrict__ x_sc, const int & i_offset, const int & i_max, const int & k, const int & nb01);
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q4_0 * bxi = ((const block_q4_0 *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI4_0) {
        ...
        const block_q4_0 * bxi = ((const block_q4_0 *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q4_1 * bxi = ((const block_q4_1 *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI4_1) {
        ...
        const block_q4_1 * bxi = ((const block_q4_1 *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q5_0 * bxi = ((const block_q5_0 *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI5_0) {
        ...
        const block_q5_0 * bxi = ((const block_q5_0 *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q5_1 * bxi = ((const block_q5_1 *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI5_1) {
        ...
        const block_q5_1 * bxi = ((const block_q5_1 *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q8_0 * bxi = ((const block_q8_0 *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI8_0) {
        ...
        const block_q8_0 * bxi = ((const block_q8_0 *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q2_K * bxi = ((const block_q2_K *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI2_K) {
        ...
        const block_q2_K * bxi = ((const block_q2_K *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * 4) {
        ...
        const block_q2_K * bxi = ((const block_q2_K *) (x + i*nb01)) + (k % (WARP_SIZE/4)) / (QI2_K/4);
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q3_K * bxi = ((const block_q3_K *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI3_K) {
        ...
        const block_q3_K * bxi = ((const block_q3_K *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * 2) {
        ...
        const block_q3_K * bxi = ((const block_q3_K *) (x + i*nb01)) + (k % (WARP_SIZE/2)) / (QI3_K/2);
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * 4) {
        ...
        const block_q3_K * bxi = ((const block_q3_K *) (x + i*nb01)) + (k % (WARP_SIZE/4)) / (QI3_K/4);
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q4_K * bxi = ((const block_q4_K *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI4_K) {
        ...
        const block_q4_K * bxi = ((const block_q4_K *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * 8) {
        ...
        const block_q4_K * bxi = ((const block_q4_K *) (x + i*nb01)) + (k % (WARP_SIZE/8)) / (QI4_K/8);
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q5_K * bxi = ((const block_q5_K *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI5_K) {
        ...
        const block_q5_K * bxi = ((const block_q5_K *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * 8) {
        ...
        const block_q5_K * bxi = ((const block_q5_K *) (x + i*nb01)) + (k % (WARP_SIZE/8)) / (QI5_K/8);
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q6_K * bxi = ((const block_q6_K *) (x + i*nb01)) + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * QI6_K) {
        ...
        const block_q6_K * bxi = ((const block_q6_K *) (x + i*nb01)) + kbxd;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps * 8) {
        ...
        const block_q6_K * bxi = ((const block_q6_K *) (x + i*nb01)) + (k % (WARP_SIZE/8)) / 4;
...
void ggml_cuda_op_mul_mat_q(
    ...
    const int mmq_x_max = cc >= CC_VOLTA ? 128 : 64;
    ...
    switch (mmq_x_best) {
        case 8:
            mul_mat_q<type,  8, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 16:
            mul_mat_q<type, 16, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 24:
            mul_mat_q<type, 24, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 32:
            mul_mat_q<type, 32, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 40:
            mul_mat_q<type, 40, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 48:
            mul_mat_q<type, 48, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 56:
            mul_mat_q<type, 56, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 64:
            mul_mat_q<type, 64, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 72:
            mul_mat_q<type, 72, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 80:
            mul_mat_q<type, 80, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 88:
            mul_mat_q<type, 88, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 96:
            mul_mat_q<type, 96, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 104:
            mul_mat_q<type, 104, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 112:
            mul_mat_q<type, 112, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 120:
            mul_mat_q<type, 120, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
        case 128:
            mul_mat_q<type, 128, mmq_y, need_check><<<block_nums, block_dims, 0, stream>>>
                (src0_dd_i, src1_ddq_i, dst_dd_i, ne00, row_diff, nb01, src1_padded_row_size, src1_ncols, nrows_dst);
            break;
    }
