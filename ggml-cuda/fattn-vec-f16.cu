...
template<int D, int ncols, int parallel_blocks, vec_dot_fattn_vec_KQ_t vec_dot_KQ, bool Q_q8_1, dequantize_1_f16_t dequantize_1_v> // D == head size
...
void launch_fattn_tile_f16_K_type(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    switch (K->type) {
        case GGML_TYPE_Q4_0: {
            fattn_kernel_t fattn_kernel = flash_attn_vec_ext_f16<D, cols_per_block, parallel_blocks, vec_dot_fattn_vec_KQ_q4_0<D>, true, dequantize_1_v>;
            launch_fattn<D, parallel_blocks>(ctx, dst, fattn_kernel, nwarps, cols_per_block);
        } break;
        case GGML_TYPE_Q4_1: {
        ...
        case GGML_TYPE_Q5_1: {
            fattn_kernel_t fattn_kernel = flash_attn_vec_ext_f16<D, cols_per_block, parallel_blocks, vec_dot_fattn_vec_KQ_q5_1<D>, true, dequantize_1_v>;
            launch_fattn<D, parallel_blocks>(ctx, dst, fattn_kernel, nwarps, cols_per_block);
        } break;
        case GGML_TYPE_Q8_0: {
        ...
        case GGML_TYPE_F16: {
            fattn_kernel_t fattn_kernel = flash_attn_vec_ext_f16<D, cols_per_block, parallel_blocks, vec_dot_fattn_vec_KQ_f16<D>, false, dequantize_1_v>;
            launch_fattn<D, parallel_blocks>(ctx, dst, fattn_kernel, nwarps, cols_per_block);
        } break;
        default:
            GGML_ASSERT(false);
