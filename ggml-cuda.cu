...
static void ggml_cuda_op_flatten_new(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst, const ggml_cuda_op_flatten_t op) {
...
static void ggml_cuda_op_flatten(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst, const ggml_cuda_op_t op) {
    ...
    // do the computation
    op(src0, src1, dst, nullptr, src0_ddf, src1_ddf, dst_ddf, 0, 0, nrows0, 0, cudaStream_main);
    CUDA_CHECK(cudaGetLastError());
...
void ggml_cuda_add(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_add);
}
...
void ggml_cuda_gelu(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_gelu);
}

void ggml_cuda_silu(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_silu);
}

void ggml_cuda_norm(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_norm);
}
...
void ggml_cuda_scale(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_scale);
}
...
void ggml_cuda_diag_mask_inf(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_diag_mask_inf);
}

void ggml_cuda_soft_max(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ggml_cuda_op_flatten_new(src0, src1, dst, ggml_cuda_op_soft_max);
}
