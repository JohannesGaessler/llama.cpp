...
typedef void (*ggml_cuda_op_mul_mat_t)(
    ...
    const char * src1_ddq_i, float * dst_dd_i, const int64_t row_low, const int64_t row_high, cudaStream_t & cudaStream_main);
...
inline void ggml_cuda_op_add(
    ...
    if (src0->type == GGML_TYPE_F32 && dst->type == GGML_TYPE_F32) {
        ...
        add_f16_f32_f16_cuda((const half *) src0_dd, src1_dd, (half *) dst_dd, ggml_nelements(src0), cudaStream_main);
    } else {
        GGML_ASSERT(false);
    }
...
inline void ggml_cuda_op_gelu(
    ...
    gelu_f32_cuda(src0_dd, dst_dd, ggml_nelements(src0), cudaStream_main);
...
inline void ggml_cuda_op_silu(
    ...
    silu_f32_cuda(src0_dd, dst_dd, ggml_nelements(src0), cudaStream_main);
...
inline void ggml_cuda_op_norm(
    ...
    norm_f32_cuda(src0_dd, dst_dd, ne00, nrows, cudaStream_main);
...
inline void ggml_cuda_op_mul_mat_q(
    ...
    switch (src0->type) {
        case GGML_TYPE_Q4_0:
            ggml_mul_mat_q4_0_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q4_1:
            ggml_mul_mat_q4_1_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q5_0:
            ggml_mul_mat_q5_0_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q5_1:
            ggml_mul_mat_q5_1_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q8_0:
            ggml_mul_mat_q8_0_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q2_K:
            ggml_mul_mat_q2_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q3_K:
            ggml_mul_mat_q3_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q4_K:
            ggml_mul_mat_q4_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q5_K:
            ggml_mul_mat_q5_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        case GGML_TYPE_Q6_K:
            ggml_mul_mat_q6_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, ne11, padded_row_size, nrows_dst, cudaStream_main);
            break;
        default:
            GGML_ASSERT(false);
            break;
...
inline void ggml_cuda_op_mul_mat_vec(
    ...
    if (use_mul_mat_vec_q) {
        ...
        switch (src0->type) {
            case GGML_TYPE_Q4_0:
                mul_mat_vec_q4_0_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q4_1:
                mul_mat_vec_q4_1_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q5_0:
                mul_mat_vec_q5_0_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q5_1:
                mul_mat_vec_q5_1_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q8_0:
                mul_mat_vec_q8_0_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q2_K:
                mul_mat_vec_q2_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q3_K:
                mul_mat_vec_q3_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q4_K:
                mul_mat_vec_q4_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q5_K:
                mul_mat_vec_q5_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q6_K:
                mul_mat_vec_q6_K_q8_1_cuda(src0_dd_i, src1_q8_1, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            default:
                GGML_ASSERT(false);
                break;
        ...
        switch (src0->type) {
            case GGML_TYPE_Q4_0:
                dequantize_mul_mat_vec_q4_0_cuda(src0_dd_i, src1_dfloat, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q4_1:
                dequantize_mul_mat_vec_q4_1_cuda(src0_dd_i, src1_dfloat, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q5_0:
                dequantize_mul_mat_vec_q5_0_cuda(src0_dd_i, src1_dfloat, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q5_1:
                dequantize_mul_mat_vec_q5_1_cuda(src0_dd_i, src1_dfloat, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q8_0:
                dequantize_mul_mat_vec_q8_0_cuda(src0_dd_i, src1_dfloat, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q2_K:
                dequantize_mul_mat_vec_q2_K_cuda(src0_dd_i, src1_ddf_i, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q3_K:
                dequantize_mul_mat_vec_q3_K_cuda(src0_dd_i, src1_ddf_i, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q4_K:
                dequantize_mul_mat_vec_q4_K_cuda(src0_dd_i, src1_ddf_i, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q5_K:
                dequantize_mul_mat_vec_q5_K_cuda(src0_dd_i, src1_ddf_i, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_Q6_K:
                dequantize_mul_mat_vec_q6_K_cuda(src0_dd_i, src1_ddf_i, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            case GGML_TYPE_F16:
                convert_mul_mat_vec_f16_cuda(src0_dd_i, src1_dfloat, dst_dd_i, ne00, row_diff, cudaStream_main);
                break;
            default:
                GGML_ASSERT(false);
                break;
...
inline void ggml_cuda_op_mul_mat_cublas(
    ...
    to_fp32_cuda(src0_dd_i, src0_ddf_i, row_diff*ne00, cudaStream_main);
...
inline void ggml_cuda_op_rope(
    ...
    // compute
    if (is_glm) {
        rope_glm_f32_cuda(src0_dd, dst_dd, ne00, nrows, p0, freq_scale, ne01, theta_scale, n_ctx, cudaStream_main);
    } else if (is_neox) {
        GGML_ASSERT(ne00 == n_dims && "ne00 != n_dims is not implemented for CUDA yet");
        rope_neox_f32_cuda(src0_dd, dst_dd, ne00, nrows, p0, freq_scale, ne01, theta_scale, cudaStream_main);
    } else {
        rope_f32_cuda(src0_dd, dst_dd, ne00, nrows, p0, freq_scale, ne01, theta_scale, cudaStream_main);
    }
...
inline void ggml_cuda_op_diag_mask_inf(
    ...
    diag_mask_inf_f32_cuda(src0_dd, dst_dd, ne00, nrows0, ne01, n_past, cudaStream_main);
...
inline void ggml_cuda_op_soft_max(
    ...
    soft_max_f32_cuda(src0_dd, dst_dd, ne00, nrows, cudaStream_main);
...
inline void ggml_cuda_op_scale(
    ...
    scale_f32_cuda(src0_dd, dst_dd, scale, ggml_nelements(src0), cudaStream_main);
...
static void ggml_cuda_op_flatten(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst, const ggml_cuda_op_flatten_t op) {
    ...
    if (src0_on_device) {
        ...
        CUDA_CHECK(ggml_cuda_cpy_tensor_2d(src0_ddf, src0, 0, 0, 0, nrows0, cudaStream_main));
    }
    ...
    if (use_src1 && !src1_stays_on_host) {
        if (src1_on_device) {
            ...
            CUDA_CHECK(ggml_cuda_cpy_tensor_2d(src1_ddf, src1, 0, 0, 0, nrows1, cudaStream_main));
        }
    }
    if (dst_on_device) {
    ...
    // do the computation
    op(src0, src1, dst, src0_ddf, src1_ddf, dst_ddf, cudaStream_main);
    CUDA_CHECK(cudaGetLastError());

    // copy dst to host if necessary
    if (!dst_on_device) {
        CUDA_CHECK(cudaMemcpyAsync(dst->data, dst_ddf, ggml_nbytes(dst), cudaMemcpyDeviceToHost, cudaStream_main));
    }
...
static void ggml_cuda_op_mul_mat(const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst, ggml_cuda_op_mul_mat_t op) {
    const int64_t ne00 = src0->ne[0];
    const int64_t ne01 = src0->ne[1];
    const int64_t ne02 = src0->ne[2];
    const int64_t ne03 = src0->ne[3];
    ...
    const size_t q8_1_ts = ggml_type_size(GGML_TYPE_Q8_1);
    const size_t q8_1_bs = ggml_blck_size(GGML_TYPE_Q8_1);
    ...
    for (int id = 0; id < g_device_count; ++id) {
        ...
        if (src1_on_device && src1_is_contiguous) {
            ...
            src1_ddf[id] = (float *) ggml_cuda_pool_malloc(ggml_nbytes(src1), &src1_as[id]);
        }
        ...
        for (int64_t i0 = 0; i0 < ne13*ne12; ++i0) {
            ...
            char  * src1_ddq_i = src1_ddq[id] +  i0              * ne11*ne10*q8_1_ts/q8_1_bs;
            ...
            // do the computation
            op(src0, src1, dst, src0_dd_i, src1_ddf_i, src1_ddq_i, dst_dd_i, row_low, row_high, cudaStream_main);
            CUDA_CHECK(cudaGetLastError());
        ...
        if (src1_as[id] > 0) {
            ggml_cuda_pool_free(src1_ddf[id], src1_as[id]);
        }
        if (dst_as[id] > 0) {
