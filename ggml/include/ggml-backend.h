...
extern "C" {
    ...
    GGML_API void ggml_backend_meta_buffer_set_tensors(ggml_backend_buffer_t meta_buf, struct ggml_tensor ** tensors, size_t n_tensors);
    ...
    */
    ...
    GGML_API enum ggml_status ggml_backend_tensor_alloc_rel(ggml_backend_buffer_t buffer, struct ggml_tensor * tensor, size_t offset);
