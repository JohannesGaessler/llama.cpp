...
for type in TYPES_MMQ:
    for need_check in ["true", "false"]:
        with open(f"mmq-instance-{get_short_name(type)}-nc_{need_check}.cu", "w") as f:
            f.write(SOURCE_MMQ.format(type=type, need_check=need_check))
