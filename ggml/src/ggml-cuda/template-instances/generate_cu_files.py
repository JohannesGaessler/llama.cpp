...
DECL_FATTN_VEC_CASE({head_size}, {type_k}, {type_v});
"""
...
for type_k in TYPES_KV:
    for type_v in TYPES_KV:
        for head_size in get_head_sizes(type_k, type_v):
            with open(f"fattn-vec-instance-hs{head_size}-{get_short_name(type_k)}-{get_short_name(type_v)}.cu", "w") as f:
                f.write(SOURCE_FATTN_VEC.format(head_size=head_size, type_k=type_k, type_v=type_v))
