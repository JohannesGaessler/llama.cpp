...
static constexpr __host__ __device__ fattn_mma_config ggml_cuda_fattn_mma_get_config_ampere(const int DKQ, const int DV, const int ncols) {
    ...
    GGML_CUDA_FATTN_MMA_CONFIG_CASE(512, 512,  8,  64, 4,  32, 256, 256, 128, 1, true);
    GGML_CUDA_FATTN_MMA_CONFIG_CASE(512, 512, 16,  64, 4,  32, 256, 256, 128, 1, true);
    GGML_CUDA_FATTN_MMA_CONFIG_CASE(512, 512, 32, 128, 2,  32, 128, 128, 128, 1, true);
    GGML_CUDA_FATTN_MMA_CONFIG_CASE(512, 512, 64, 256, 1,  32, 128, 128, 128, 1, true);
...
DECL_FATTN_MMA_F16_CASE_ALL_NCOLS2(512, 512,   8)
...
DECL_FATTN_MMA_F16_CASE_ALL_NCOLS2(512, 512,  16)
...
DECL_FATTN_MMA_F16_CASE_ALL_NCOLS2(512, 512,  32)
...
DECL_FATTN_MMA_F16_CASE_ALL_NCOLS2(512, 512,  64)
