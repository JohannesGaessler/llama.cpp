...
static constexpr __host__ __device__ ggml_cuda_mmq_config ggml_cuda_mmq_get_config_pascal(const ggml_type type, const int J, const bool fallback) {
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,   8, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, true);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  16, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, true);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  32, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, true);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  64, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, true);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,   8, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, false);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  16, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, false);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  24, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, false);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  32, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, false);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  48, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, false);
    CASE(GGML_TYPE_Q8_0, 256, 2, 64,  64, MMQ_MMA_TILE_X_K_Q8_0, MMQ_ITER_K, false, false);
...
template <ggml_type type, int J, bool fallback> static __device__ __forceinline__ void mmq_write_back_dp4a(
        ...
        switch (type) {
            case GGML_TYPE_Q1_0:
                return ggml_cuda_mmq_util_funcs(
                    ...
                    vec_dot_q8_0_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q4_0:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q4_0_Q8_1_MMQ,
                    load_tiles_q4_0<type, J, fallback>,
                    vec_dot_q4_0_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q4_1:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q4_1_Q8_1_MMQ,
                    load_tiles_q4_1<type, J, fallback>,
                    vec_dot_q4_1_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q5_0:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q5_0_Q8_1_MMQ,
            ...
            case GGML_TYPE_Q5_1:
                return ggml_cuda_mmq_util_funcs(
                    ...
                    vec_dot_q8_1_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q8_0:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q8_0_Q8_1_MMQ,
...
// ---------------------------------------------------------------------------------------------
            case GGML_TYPE_Q2_K:
                return ggml_cuda_mmq_util_funcs(
                    ...
                    vec_dot_q2_K_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q3_K:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q3_K_Q8_1_MMQ,
                    load_tiles_q3_K<type, J, fallback>,
                    vec_dot_q3_K_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q4_K:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q4_K_Q8_1_MMQ,
                    load_tiles_q4_K<type, J, fallback>,
                    vec_dot_q4_K_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q5_K:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q5_K_Q8_1_MMQ,
                    load_tiles_q5_K<type, J, fallback>,
                    vec_dot_q5_K_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q6_K:
                return ggml_cuda_mmq_util_funcs(
                    VDR_Q6_K_Q8_1_MMQ,
                    load_tiles_q6_K<type, J, fallback>,
                    vec_dot_q6_K_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
// ---------------------------------------------------------------------------------------------
            case GGML_TYPE_IQ1_S:
                return ggml_cuda_mmq_util_funcs(
            ...
            case GGML_TYPE_IQ2_XS:
                return ggml_cuda_mmq_util_funcs(
                    ...
                    vec_dot_q8_0_16_q8_1_dp4a<type, J, fallback>,
                    mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_IQ2_S:
                return ggml_cuda_mmq_util_funcs(
                    VDR_IQ2_S_Q8_1_MMQ,
