...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        const int grid = iq1s_grid_gpu[bq1->qs[4*iqs + l0/2] | (((bq1->qh[iqs] >> 3*(l0/2)) & 0x07) << 8)];
...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        const int * grid = (const int *)(iq1s_grid_gpu + (bq1->qs[4*iqs + l0/2] | (((bq1->qh[2*iqs + l0/4] >> 4*((l0/2)%2)) & 7) << 8)));
