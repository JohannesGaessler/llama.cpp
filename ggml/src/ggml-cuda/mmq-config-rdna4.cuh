...
// ---------------------------------------------------------------------------------------------
    ...
    CASE(GGML_TYPE_F32, 128, 2, 128,  16, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, true);
    CASE(GGML_TYPE_F32, 128, 2, 128,  32, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, true);
    CASE(GGML_TYPE_F32, 128, 2, 128,  64, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, true);
    CASE(GGML_TYPE_F32, 128, 2, 128, 128, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, true);
    CASE(GGML_TYPE_F32, 128, 2, 128,  16, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128,  32, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128,  48, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128,  64, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128,  80, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128,  96, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128, 112, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
    CASE(GGML_TYPE_F32, 128, 2, 128, 128, GGML_CUDA_MMQ_SRAM_LAYOUT_F32, 32, false, false);
