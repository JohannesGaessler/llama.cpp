...
extern "C" {
    ...
    struct ggml_backend_i {
        ...
        // (optional) backend-specific AllGather operation for meta backend
        bool (*allgather_tensor_async)(ggml_backend_t * backends, struct ggml_tensor ** tensors, size_t n_backends);
